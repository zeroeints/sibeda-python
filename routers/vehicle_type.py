...
@router.get("/", response_model=schemas.SuccessListResponse[schemas.VehicleTypeResponse])
...
@router.get("/{vt_id}", response_model=schemas.SuccessResponse[schemas.VehicleTypeResponse])
...
@router.post("/", response_model=schemas.SuccessResponse[schemas.VehicleTypeResponse])
def create_vehicle_type(payload: schemas.VehicleTypeBase, request: Request, db: Session = Depends(get_db), _u: UserModel = Depends(auth.get_current_user)):
...
@router.put("/{vt_id}", response_model=schemas.SuccessResponse[schemas.VehicleTypeResponse])
def update_vehicle_type(vt_id: int, payload: schemas.VehicleTypeBase, request: Request, db: Session = Depends(get_db), _u: UserModel = Depends(auth.get_current_user)):
...
@router.delete("/{vt_id}", response_model=schemas.SuccessResponse[schemas.Message])
