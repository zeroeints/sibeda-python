...
def get_vehicle_type(
    ...
    lang = detect_lang(request)
    return schemas.SuccessResponse[schemas.VehicleTypeResponse](
        data=vt, message=get_message("create_success", lang)
    )
...
def create_vehicle_type(
    ...
    lang = detect_lang(request)
    return schemas.SuccessResponse[schemas.VehicleTypeResponse](
        data=created, message=get_message("vehicle_type_create_success", lang)
    )
...
def update_vehicle_type(
    ...
    lang = detect_lang(request)
    return schemas.SuccessResponse[schemas.VehicleTypeResponse](
        data=updated, message=get_message("vehicle_type_update_success", lang)
    )
...
def delete_vehicle_type(
    ...
    return schemas.SuccessResponse[schemas.Message](
        data=schemas.Message(detail="VehicleType dihapus"),
        message=get_message("vehicle_type_delete_success", lang),
    )